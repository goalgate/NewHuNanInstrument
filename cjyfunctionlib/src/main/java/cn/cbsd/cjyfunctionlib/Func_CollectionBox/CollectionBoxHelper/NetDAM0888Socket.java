...
public class NetDAM0888Socket {
    ...
    protected NetDAM0888CMD cmd = new NetDAM0888CMD();
    protected int[] data_ai = new int[8]; //8个模拟量采集值
                ...
                while (isRev_) {
                    ...
                    if (openState_ != 1 || client == null || inData == null) {
                        try {
                            ...
                            Log.e("NetDAM0888Socket.sleep", ex.toString());
                        }
                        continue;
                    }
                    ...
                    try {
                        ...
                        try {
                            ...
                            Log.e("NetDAM0888Socket.sleep", exx.toString());
                        }
                        Log.e("NetDAM0888Socket.inData", ex.toString());
                        continue;
                    }
    ...
    public void sendData(int iType, byte[] bs) {
        try {
            ...
            Log.e("NetSocket.sendData", ex.toString());
        }
    }
        ...
        if (enable_) {
            if (event_ != null) {
                try {
                    ...
                    Log.e("NetDAM0888Socket.onOpen", ex1.toString());
                }
            }
        }
    }
        ...
        if (enable_) {
            if (event_ != null) {
                try {
                    ...
                    Log.e("NetSocket.onInState", ex1.toString());
                }
            }
        }
    }
        ...
        if (enable_) {
            if (event_ != null) {
                try {
                    ...
                    Log.e("NetDAM0888Socket.onCmd", ex1.toString());
                }
            }
        }
    }
