...
import cn.cbsd.cjyfunctionlib.Func_FingerPrint.FingerPrintHelper.DevComm;
import cn.cbsd.cjyfunctionlib.Func_FingerPrint.FingerPrintHelper.IUsbConnState;
...
public class FingerPrintImpl implements IFingerPrint {
    ...
    @Override
    public void onInit(Context context, IFPListener fplistener) {
            ...
            public void run() {
                ...
                while (true) {
                    ...
                    if (w_nRet == DevComm.ERR_SUCCESS) {
                        ...
                        handler.sendMessage(getMsg(0x456));
                        m_strPost = String.format("校验模板编号 No : %d 成功，匹配时间 : %dms", w_nID[0], m_nPassedTime);
                        handler.sendMessage(getMsg(0x234));
