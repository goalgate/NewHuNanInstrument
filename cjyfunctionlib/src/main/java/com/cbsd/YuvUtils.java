...
/**
 * @author Created by WZW on 2021-02-07 18:49.
 * @description
 */
public class YuvUtils {
    ...
    /**
     * (nv21-->i420-->rotate-->clip-->scale-->mirror-->nv21)
     *
     * @param nv21Src  原始数据
     * @param width    原始的宽
     * @param height   原始的高
     * @param nv21Dst  目标数据
     * @param degree   旋转角度
     * @param yStart   裁剪top坐标
     * @param yStop    裁剪bottom坐标
     * @param isMirror 是否镜像
     * @param mode     压缩模式 ，0~3，质量由低到高，一般传入0
     */
    public static native void yuvRevert3399(byte[] nv21Src, int width, int height, byte[] nv21Dst, int degree, int yStart, int yStop, boolean isMirror, int mode);
