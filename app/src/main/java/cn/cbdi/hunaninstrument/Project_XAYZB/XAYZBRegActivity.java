...
public class XAYZBRegActivity extends RxActivity implements IFaceView, IIDCardView {

    private String TAG = XAYZBRegActivity.class.getSimpleName();
...
//    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        disposableTimer = RxTextView.textChanges(tv_timer)
                ...
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe((charSequence) -> fp.PreviewCease(() -> XAYZBRegActivity.this.finish()));
    ...
    public void onsetICCardInfo(ICardInfo cardInfo) {
        if (cardInfo.getUid().equals(AppInit.The_IC_UID)) {
            fp.PreviewCease(() -> XAYZBRegActivity.this.finish());
        } else {
...
//        }
    ...
    private void faceUpload() {
        ...
        RetrofitGenerator.getXAYZBApi().faceUpload("faceUpload", paramsMap.get("daid"), paramsMap.get("pass"), jsonObject.toString())
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    private void recentPic() {
        ...
        natural = false;
        idp.StopReadID();
        RetrofitGenerator.getXAYZBApi().recentPicNew("recentPic", paramsMap.get("daid"), paramsMap.get("pass"), global_cardInfo.cardId())
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
