                                                        ...
                                                        try {
                                                            ...
                                                            for (Keeper keeper : keeperList) {
                                                                try {
                                                                    ...
                                                                    FacePresenter.getInstance().FaceDelete(keeper.getName());
                                                                }
                                                            }
                                        ...
                                        try {
                                            ...
                                            if (!TextUtils.isEmpty(ps)) {
                                                ...
                                                if (FacePresenter.getInstance().FaceRegByBase64(name,employer.getCardID(),ps)) {
                                                    User user = FacePresenter.getInstance().GetUser(name);
...
//        String pattern = "yyyy-MM-dd '17:00:00'";
        ...
        try {
            ...
            TimerTask task = new TimerTask() {
                ...
                public void run() {
                    // 要执行的代码
                    CJYHelper.getInstance(HuNanService.this).reboot();
                    Log.e("信息提示", "关机了");
                }
            };
