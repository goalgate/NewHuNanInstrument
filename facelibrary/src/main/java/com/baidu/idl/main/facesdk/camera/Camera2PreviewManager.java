...
public class Camera2PreviewManager implements TextureView.SurfaceTextureListener {
    ...
    private static volatile Camera2PreviewManager instance = null;
    ...
    public static Camera2PreviewManager getInstance() {
        synchronized (Camera2PreviewManager.class) {
            if (instance == null) {
                instance = new Camera2PreviewManager();
            }
        }
        return instance;
    }
